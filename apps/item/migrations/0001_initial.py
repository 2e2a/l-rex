...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('question', models.CharField(help_text='TODO This text will precede the stimulus (e.g. "How acceptable is this sentence?")', max_length=1000)),
                ('scale_labels', models.CharField(blank=True, help_text='TODO comma separated', max_length=500, null=True)),
                ('legend', models.CharField(blank=True, help_text='TODO This legend will appear below the stimulus to clarify the scale (e.g. "1 = bad, 5 = good").', max_length=1000, null=True)),
            ],
            options={
                'ordering': ['question'],
            },
