    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('question', models.CharField(blank=True, help_text='TODO This text will precede the stimulus (e.g. "How acceptable is this sentence?")', max_length=200, null=True)),
                ...
                ('progress', models.CharField(choices=[('11-qst-crt', 'Create a question'), ('12-qst-scl', 'Create scale for question')], default='11-qst-crt', max_length=16)),
            ],
            options={
                'ordering': ['pk'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('progress', models.CharField(choices=[('00-std-crt', 'Create a study'), ('10-qst-crt', 'Create a question'), ('19-qst-cmp', 'Complete a question creation'), ('20-exp-crt', 'Create an experiment'), ('29-exp-cmp', 'Complete the experiment creation'), ('30-std-qnr-gen', 'Generate questionnaires'), ('40-std-pub', 'Publish the study')], default='00-std-crt', max_length=16)),
