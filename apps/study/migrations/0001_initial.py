    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('participation_id_label', models.CharField(default='Participation ID', help_text='Label used for the participant ID form on the instruction page or for the participation code on the outro page, depending on the "participant ID" setting.', max_length=40)),
