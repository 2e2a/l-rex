# Generated by Django 2.0.1 on 2018-02-12 15:08
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('responsesettings_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='lrex_response.ResponseSettings')),
                ('yes', models.CharField(max_length=200)),
                ('no', models.CharField(max_length=200)),
            ],
            bases=('lrex_response.responsesettings',),
        ),
        migrations.AddField(
